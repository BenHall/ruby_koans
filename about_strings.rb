...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why?
		# + returns a new string as strings as immutable. 
		# For example:
		# irb(main):025:0> a = "ABC"
		# => "ABC"
		# irb(main):026:0> a.object_id
		# => 26740710
		# irb(main):027:0> a += "TEST"
		# => "ABCTEST"
		# irb(main):028:0> a.object_id
		# => 26734190
		#
		# Same variable, but different strings
		# irb(main):029:0> b = "ABC"
		# => "ABC"
		# irb(main):030:0> b.object_id
		# => 26727870
		# irb(main):031:0> b << "TEST"
		# => "ABCTEST"
		# irb(main):032:0> b.object_id
		# => 26727870
		#
		# Result is the same string - uses less memory so scales more effectively.
  end
