...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Because there wasn't anything else to match as part of the regex. It's 0 or more
  end
  ...
  #
  # Why?
  # As many matches as possible are returned
  # ------------------------------------------------------------------
  ...
  # Alternations allow for use of words instead of single characters
